...
> A Picasso painting webpage built using some intermediate CSS techniques such as SVG icons, CSS positioning and other designing tools.
...
- CSS properties
  ...
  - CSS Typography properties
    `white-space`, `font-style`, `font-family`, `color`, etc
  - CSS Box Model properties
    `padding`, `margin`, `width`, `box-sizing`, etc
  - CSS Displaying properties
    `display`,
  - CSS Flexbox properties
    `flex-direction`, `justify-content`, `overflow`,
- Linters
